...
class ActivityForm(forms.ModelForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        # user_activity_types = models.Activity_type.objects.filter(timetable__id__in=assigned_timetables.values("timetable_id"))
...
class TimetableMergingForm(forms.Form):
    ...
    timetable1 = forms.ModelChoiceField(queryset=models.Timetable.objects.none(),
                                        required=True, help_text="First timetable")
    timetable2 = forms.ModelChoiceField(queryset=models.Timetable.objects.none(),
                                        required=True, help_text="Second timetable")
