...
class ActivityForm(forms.ModelForm):
    ...
    course = forms.ModelChoiceField(queryset=models.Course.objects.all(), required=False, help_text="Course")
    activity_type = forms.ModelChoiceField(queryset=models.Activity_type.objects.all(), required=False, help_text="Activity type")
    class Meta:
...
class TeacherForm(forms.ModelForm):
    class Meta:
        ...
        fields = ["teacher_first_name", "teacher_last_name", "teacher_link", "teacher_mail"]
